...
And after that you could up machines by using "test_framework":https://github.com/dellcloudedge/crowbar/tree/master/test_framework that is a part of the Crowbar on your machine. In this case run this command:
