...
In order to start building ISO file go to this "page":https://github.com/dellcloudedge/crowbar/wiki/Build-Crowbar.ISO describing how to start this process and then add "barclamp-cassandra":https://github.com/shvid/barclamp-cassandra sub module by running the commands:
...
Make sure that for new cluster name "barclamp-cassandra":https://github.com/shvid/barclamp-cassandra will remove all data in directories "Saved Caches Directory, Commitlog Directory, Data File Directories" by command
