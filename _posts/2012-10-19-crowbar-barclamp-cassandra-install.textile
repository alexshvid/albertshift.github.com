...
DELL Crowbar is an opensource framework that has plugins, called barclamps, used for installing and configuring software on physical machines. I have written the "barclamp_cassandra":https://github.com/shvid/barclamp-cassandra for Apache Cassandra installation and configuration by means Crowbar Barclamps. Let's consider steps for quick installation of Cassandra on your environment.
